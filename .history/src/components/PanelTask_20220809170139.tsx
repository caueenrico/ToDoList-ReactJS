...
export function PanelTasks() {
  return (
    <div className={style.containerPai}>
      ...
      <label>
        <input type="checkbox" />
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur voluptates 
          praesentium odit distinctio blanditiis neque quasi consequatur repellat facilis quo nisi temporibus eveniet magnam, possimus enim unde quia harum reprehenderit.</p>
      </label>
